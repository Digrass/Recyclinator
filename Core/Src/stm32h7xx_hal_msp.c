...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* htim_base)
{
  ...
  else if(htim_base->Instance==TIM23)
  {
    ...
    PF9     ------> TIM23_CH4
    */
    GPIO_InitStruct.Pin = US2_EC_Pin|US1_EC_Pin|US0_EC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  if(htim->Instance==TIM1)
  {
    ...
    PE14     ------> TIM1_CH4
    */
    GPIO_InitStruct.Pin = SM0_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM1;
    HAL_GPIO_Init(SM0_GPIO_Port, &GPIO_InitStruct);
  ...
  else if(htim->Instance==TIM4)
  {
    ...
    PD15     ------> TIM4_CH4
    */
    GPIO_InitStruct.Pin = SM1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM4;
    HAL_GPIO_Init(SM1_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  else if(htim_base->Instance==TIM23)
  {
    ...
    PF9     ------> TIM23_CH4
    */
    HAL_GPIO_DeInit(GPIOF, US2_EC_Pin|US1_EC_Pin|US0_EC_Pin);
