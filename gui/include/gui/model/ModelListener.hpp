...
public:
    ...
    virtual void notifyCapacityUpdated(OperationDirection dir, float newCapacity) {}
    virtual void notifyActionSequenceComplete(OperationDirection actionDir) {}
    virtual void requestGoToWaitScreen() {}
    virtual void requestGoToMainScreen() {}
